...
namespace NOVA.Implementations.Modulated.Periodic
{
    ...
    /// </summary>
    /// <param name="rampUpTime">Time in milliseconds for the waveform to rise from minimum to maximum value. Must be non-negative.</param>
    /// <param name="keepMaxTime">Time in milliseconds to maintain the maximum value. Must be non-negative.</param>
    /// <param name="rampDownTime">Time in milliseconds for the waveform to fall from maximum to minimum value. Must be non-negative.</param>
    /// <param name="keepMinTime">Time in milliseconds to maintain the minimum value. Must be non-negative.</param>
    /// <param name="amplitude">Peak-to-peak amplitude of the waveform, normalized to [0, 1] range. Defaults to maximum value (1).</param>
    /// <param name="offset">DC offset of the waveform, normalized to [0, 1] range. Defaults to minimum value (0).</param>
    /// <remarks>
    /// <para>The waveform's total period is the sum of all phase times: rampUpTime + keepMaxTime + rampDownTime + keepMinTime.</para>
