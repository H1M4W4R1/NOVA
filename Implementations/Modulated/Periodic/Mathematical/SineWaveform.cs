...
namespace NOVA.Implementations.Modulated.Periodic.Mathematical
{
    ...
    /// <param name="amplitude">The peak deviation of the waveform from its center position. Must be in range [0, 1]. Defaults to maximum waveform value.</param>
    /// <param name="offset">The vertical offset applied to the waveform. Must be in range [0, 1]. Defaults to minimum waveform value.</param>
