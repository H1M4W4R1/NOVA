...
namespace NOVA.Implementations.Modulated.Periodic.Mathematical
{
    ...
    /// </summary>
    /// <param name="frequency">The frequency of the waveform in Hertz (Hz). Determines how many complete cycles occur per second.</param>
    /// <param name="amplitude">The peak amplitude of the waveform, normalized to range [0, 1]. Represents the maximum deviation from the offset.</param>
    /// <param name="offset">The vertical offset of the waveform, normalized to range [0, 1]. Automatically clamped to prevent amplitude overflow.</param>
