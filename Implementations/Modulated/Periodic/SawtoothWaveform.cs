...
namespace NOVA.Implementations.Modulated.Periodic
{
    ...
    /// <param name="inverted">When true, the waveform starts at maximum amplitude and ramps down. When false, it starts at minimum and ramps up.</param>
    /// <remarks>
    /// <para>
    ...
    ) : FAOWaveform(frequency, amplitude, offset)
    {
        ...
        /// </summary>
        /// <param name="inverted">The desired inversion state:
        /// <list type="bullet">
        /// <item><description>True: Waveform will be inverted (falling ramp)</description></item>
        /// <item><description>False: Waveform will be standard (rising ramp)</description></item>
        /// </list>
        /// </param>
