...
namespace NOVA.Implementations.Modulated.Periodic
{
    ...
    /// <param name="fillFactor">The duty cycle ratio (0-1) determining the proportion of time the waveform is at maximum amplitude. Default is 0.5 (50% duty cycle).</param>
    /// <remarks>
